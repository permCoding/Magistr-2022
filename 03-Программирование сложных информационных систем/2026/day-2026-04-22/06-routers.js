...
const rOrderUsers = require('./routers/rOrderUsers');
const rGetUsers = require('./routers/rGetUsers');
...
app.use('/order', rOrderUsers); // подключили роутер
app.use('/', rGetUsers); // подключили роутер

app.listen(PORT, HOST, () => console.log(`http://${HOST}:${PORT}/`));



// можно сделать путь к файлам данных так:
// global.filename = './json/users.json'; // адрес локального хранилища
