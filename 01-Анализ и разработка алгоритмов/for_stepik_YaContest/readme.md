...
- Я отключил штраф за подачу неправильного решения, можно подавать несколько раз по одной задаче, но не более 100 попыток.  
...
- ссылка для входа по ID Yandex: https://contest.yandex.ru/contest/19616/  
